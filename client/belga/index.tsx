...
import videoEditor from "superdesk-core/scripts/extensions/videoEditor/dist/src/extension";
...
export default angular.module("belga", [belgaImage.name, belga360Archive.name]);

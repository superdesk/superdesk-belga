...
BELGA_KEYCLOAK_ENDPOINT = os.environ.get("BELGA_KEYCLOAK_ENDPOINT")
BELGA_KEYCLOAK_CLIENT_ID = os.environ.get("BELGA_KEYCLOAK_CLIENT_ID")
BELGA_KEYCLOAK_CLIENT_SECRET = os.environ.get("BELGA_KEYCLOAK_CLIENT_SECRET")
BELGAPRESS_KEYCLOAK_ENDPOINT = (
    os.environ.get("BELGAPRESS_KEYCLOAK_ENDPOINT") or BELGA_KEYCLOAK_ENDPOINT
)
BELGAPRESS_KEYCLOAK_CLIENT_ID = (
    os.environ.get("BELGAPRESS_KEYCLOAK_CLIENT_ID") or BELGA_KEYCLOAK_CLIENT_ID
)
BELGAPRESS_KEYCLOAK_CLIENT_SECRET = (
    os.environ.get("BELGAPRESS_KEYCLOAK_CLIENT_SECRET") or BELGA_KEYCLOAK_CLIENT_SECRET
)

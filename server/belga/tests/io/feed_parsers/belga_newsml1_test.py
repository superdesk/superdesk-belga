...
class ANPBelgaNewsMLTestCase(BaseBelgaNewsMLParserTestCase):
    ...
    def test_content(self):
        ...
        self.assertEqual(item["news_component_duid"], "")
...
class EFEBelgaNewsMLTestCase(BaseBelgaNewsMLParserTestCase):
    ...
    def test_content(self):
        ...
        self.assertEqual(item["type"], "text")
        self.assertEqual(item["news_component_essential"], "")
        ...
        self.assertEqual(item["news_component_equivalentslist"], "")
...
class TASSBelgaNewsMLTestCase(BaseBelgaNewsMLParserTestCase):
    ...
    def test_content(self):
        ...
        self.assertEqual(item["news_component_essential"], "")
        self.assertEqual(item["guid"], "16AAC34CE1C503AE4325838900396A95")

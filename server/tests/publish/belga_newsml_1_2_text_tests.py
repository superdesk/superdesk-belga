...
class BelgaNewsML12FormatterTextTest(TestCase):
    article = {
        ...
        "associations": {
            "editor_0": {
                ...
                "subject": [
                    ...
                    },
                    {
                        "name": "CZECHIA",
                        "qcode": "cze",
                        "translations": {"name": {"nl": "Tsjechië", "fr": "Tchéquie"}},
                        "scheme": "countries",
                    },
                ],
            },
            ...
            "editor_2": {
                ...
                "extra": {"belga-keywords": "audio, music", "city": "Pragua"},
                "headline": "audio head",
            },
            "editor_3": {
            ...
            "belga-coverages--1": {
                ...
                "extra": {"bcoverage": "provider:6690595"},
                "_links": {
                    "self": {
                        "title": "Search_providers_proxy",
        ...
        "subject": [
            ...
            {"name": "R1", "qcode": "R1", "scheme": "label"},
            {
                "name": "ARUBA",
                "qcode": "country_abw",
                "translations": {"name": {"nl": "ARUBA", "fr": "ARUBA"}},
                "scheme": "country",
            },
            {
                "name": "BIN/ALG",
        ...
        "attachments": [{"attachment": ObjectId("5d692b76c8f549e289b0270b")}],
        "genre": [
            {"name": "ANALYSIS"},
        ],
    }
    ...
    archive = (
        {
            ...
            "versioncreated": datetime.datetime(
                2019, 4, 3, 12, 41, 53, tzinfo=pytz.UTC
            ),
            "original_creator": "5d385f31fe985ec67a0ca583",
            ...
            "headline": "History",
            "extra": {"belga-keywords": "one, two, three", "city": "Prague"},
            "subject": [
                {"name": "Belga", "qcode": "Belga", "scheme": "credit"},
                {
                    "name": "BELGIUM",
                    "qcode": "bel",
                    "translations": {"name": {"nl": "België", "fr": "Belgique"}},
    ...
    @mock.patch(
        "belga.publish.belga_newsml_1_2.get_service_by_id",
        lambda _: BelgaCoverageSearchProvider({"_id": "test"}),
    )
    def setUp(self):
        init_app(self.app)
    ...
    def test_belga_text_newscomponent(self):
        ...
        self.assertDictEqual(
            dict(
                newscomponent_2_level.xpath("NewsLines/NewsLine/NewsLineType")[0].attrib
            ),
            {"FormalName": "1"},
        )
        self.assertEqual(
        ...
        self.assertDictEqual(
            dict(
                newscomponent_2_level.xpath("AdministrativeMetadata/Provider/Party")[
                    0
                ].attrib
            ),
            {"FormalName": "1"},
        ...
        self.assertDictEqual(
            dict(
                newscomponent_2_level.xpath("AdministrativeMetadata/Creator/Party")[
                    0
                ].attrib
            ),
        ...
        self.assertDictEqual(
            dict(
                newscomponent_2_level.xpath("AdministrativeMetadata/Contributor/Party")[
                    0
                ].attrib
            ),
            {"FormalName": "John"},
        ...
        expected_attribs = (
            ...
            {
                "FormalName": "NewsObjectId",
                "Value": "urn:newsml:localhost:5000:2019-04-03T15:41:53.479892:1628c9b4-6261-42c8-ad43-77c132bc0ba5",
            },
            {
                "FormalName": "EditorialInfo",
                "Value": "Vestibulum ac diam sit amet quam vehicula elementum "
                "sed sit amet dui.",
            },
        ...
        for idx, attribs in enumerate(
            [
                dict(p.attrib)
                for p in newscomponent_2_level.xpath("AdministrativeMetadata/Property")
            ]
        ):
            self.assertDictEqual(attribs, expected_attribs[idx])
        ...
        for idx, attribs in enumerate(
            [
                dict(p.attrib)
                for p in newscomponent_2_level.xpath(
                    "AdministrativeMetadata/Property/Property"
                )
            ]
        ):
            self.assertDictEqual(attribs, expected_attribs[idx])
        self.assertDictEqual(
            dict(
                newscomponent_2_level.xpath("AdministrativeMetadata/Source/Party")[
                    0
                ].attrib
            ),
            {"FormalName": "DPA/ANP"},
        ...
        self.assertDictEqual(
            dict(descriptivemetadata.attrib), {"DateAndTime": "20190403T144153"}
        )
        self.assertIsNone(descriptivemetadata.xpath("SubjectCode")[0].text)
        expected_attribs = (
        ...
        self.assertEqual(
            newscomponent_3_level.xpath("ContentItem/Characteristics/SizeInBytes")[
                0
            ].text,
            "15",
        )
    ...
    def test_url_newscomponent(self):
        ...
        self.assertEqual(
            self.newsml.xpath(
                'count(NewsItem/NewsComponent/NewsComponent/Role[@FormalName="URL"])'
            ),
            2,
        )
        newscomponent_2_level = self.newsml.xpath(
        ...
        # NewsML -> NewsItem -> NewsComponent -> NewsComponent -> Role
        self.assertDictEqual(
            dict(newscomponent_2_level.xpath("Role")[0].attrib), {"FormalName": "URL"}
        )
        # NewsML -> NewsItem -> NewsComponent -> NewsComponent -> NewsLines
        self.assertIsNone(newscomponent_2_level.xpath("NewsLines/DateLine")[0].text)
        self.assertEqual(
        ...
        self.assertEqual(
            newscomponent_2_level.xpath("NewsLines/HeadLine")[0].text, "Example com"
        )
        self.assertIsNone(
            newscomponent_2_level.xpath("NewsLines/CopyrightLine")[0].text
        )
        ...
        expected_attribs = (
            ...
            {
                "FormalName": "NewsObjectId",
                "Value": "bf744ced-ecca-4a2f-bf6d-bdd52092e31e",
            },
            {"FormalName": "NewsPackage"},
            {"FormalName": "NewsPackage"},
            {"FormalName": "NewsPackage"},
    ...
    def test_pictures_count(self):
        # NewsML -> NewsItem -> NewsComponent -> NewsComponent -> Role
        roles = self.newsml.xpath(
            'NewsItem/NewsComponent/NewsComponent/Role[@FormalName="Picture"]'
        )
        # count
    ...
    def test_gallery_count(self):
        # NewsML -> NewsItem -> NewsComponent -> NewsComponent -> Role
        roles = self.newsml.xpath(
            'NewsItem/NewsComponent/NewsComponent/Role[@FormalName="Gallery"]'
        )
        # count
    ...
    def test_audio_count(self):
        # NewsML -> NewsItem -> NewsComponent -> NewsComponent -> Role
        roles = self.newsml.xpath(
            'NewsItem/NewsComponent/NewsComponent/Role[@FormalName="Audio"]'
        )
        # count
    ...
    def test_video_count(self):
        # NewsML -> NewsItem -> NewsComponent -> NewsComponent -> Role
        roles = self.newsml.xpath(
            'NewsItem/NewsComponent/NewsComponent/Role[@FormalName="Video"]'
        )
        # count
        self.assertEqual(len(roles), 1)
    ...
    def test_related_document_count(self):
        # NewsML -> NewsItem -> NewsComponent -> NewsComponent -> Role
        roles = self.newsml.xpath(
            'NewsItem/NewsComponent/NewsComponent/Role[@FormalName="RelatedDocument"]'
        )
        # count
        self.assertEqual(len(roles), 1)
    ...
    def test_related_article_count(self):
        # NewsML -> NewsItem -> NewsComponent -> NewsComponent -> Role
        roles = self.newsml.xpath(
            'NewsItem/NewsComponent/NewsComponent/Role[@FormalName="RelatedArticle"]'
        )
        # count
    ...
    def test_uploaded_picture_in_editor(self):
        ...
        self.assertEqual(
            newscomponent_2_level.xpath("NewsLines/HeadLine")[0].text, "Mazda MX5 retro"
        )
        # NewsML -> NewsItem -> NewsComponent -> NewsComponent -> NewsLines -> CopyrightLine
        self.assertEqual(
            newscomponent_2_level.xpath("NewsLines/CopyrightLine")[0].text, "Belga"
        )
        # NewsML -> NewsItem -> NewsComponent -> NewsComponent -> NewsLines -> KeywordLine
        keywords = ("japan", "tokyo", "mazda")
        for i, keywordline in enumerate(
            newscomponent_2_level.xpath("NewsLines/KeywordLine")
        ):
            self.assertEqual(keywordline.text, keywords[i])
        ...
        self.assertDictEqual(
            dict(party[0].attrib), {"FormalName": "adm", "Topic": "AUTHOR"}
        )
        # NewsML -> NewsItem -> NewsComponent -> NewsComponent -> AdministrativeMetadata -> Property[Priority]
        priority = newscomponent_2_level.xpath(
            'AdministrativeMetadata/Property[@FormalName="Priority"]'
        )[0]
        self.assertEqual(priority.attrib["Value"], "3")
        ...
        self.assertEqual(source.attrib["FormalName"], "Belga_on_the_spot")
        # NewsML -> NewsItem -> NewsComponent -> NewsComponent -> DescriptiveMetadata[DateAndTime]
        descriptivemetadata = newscomponent_2_level.xpath("DescriptiveMetadata")[0]
        self.assertEqual(descriptivemetadata.attrib["DateAndTime"], "20190819T151501")
        # NewsML -> NewsItem -> NewsComponent -> NewsComponent -> DescriptiveMetadata -> Location
        property = newscomponent_2_level.xpath(
            'DescriptiveMetadata/Location/Property[@FormalName="City"]'
        )[0]
        self.assertEqual(property.attrib["Value"], "Tokio")
        property = newscomponent_2_level.xpath(
            'DescriptiveMetadata/Location/Property[@FormalName="Country"]'
        )[0]
        self.assertEqual(
        ...
        self.assertEqual(datacontent.text, "Mazda MX5 retro")
        ...
        self.assertEqual(sizeinbytes[0].text, "15")
        ...
        self.assertEqual(datacontent[0].text, "Mazda MX5 retro 1990")
        sizeinbytes = newscomponent_2_level.xpath(
            'NewsComponent/Role[@FormalName="Caption"]/ancestor::NewsComponent'
            "/ContentItem/Characteristics/SizeInBytes"
        )
        self.assertEqual(sizeinbytes[0].text, "20")
        ...
        self.assertEqual(sizeinbytes.text, "15")
        property = newscomponent_2_level.xpath(
            'NewsComponent/Role[@FormalName="Image"]/ancestor::NewsComponent'
            '/ContentItem/Characteristics/Property[@FormalName="Width"]'
        )[0]
        self.assertEqual(property.attrib["Value"], "3000")
        property = newscomponent_2_level.xpath(
            'NewsComponent/Role[@FormalName="Image"]/ancestor::NewsComponent'
            '/ContentItem/Characteristics/Property[@FormalName="Height"]'
        )[0]
        self.assertEqual(property.attrib["Value"], "2000")
    ...
    def test_belga_picture_in_editor(self):
        ...
        # NewsML -> NewsItem -> NewsComponent -> NewsComponent -> NewsLines -> CopyrightLine
        self.assertEqual(
            newscomponent_2_level.xpath("NewsLines/CopyrightLine")[0].text, None
        )
        # NewsML -> NewsItem -> NewsComponent -> NewsComponent -> NewsLines -> KeywordLine
        self.assertEqual(newscomponent_2_level.xpath("count(NewsLines/KeywordLine)"), 0)
        # NewsML -> NewsItem -> NewsComponent -> NewsComponent -> AdministrativeMetadata -> Property[NewsObjectId]
        newsobjectid = newscomponent_2_level.xpath(
            'AdministrativeMetadata/Property[@FormalName="NewsObjectId"]'
        )[0]
        self.assertEqual(newsobjectid.attrib["Value"], "urn:belga.be:image:154620545")
        # NewsML -> NewsItem -> NewsComponent -> NewsComponent -> AdministrativeMetadata -> Source
        source = newscomponent_2_level.xpath("AdministrativeMetadata/Source/Party")[0]
        self.assertEqual(source.attrib["FormalName"], "ZUMAPRESS")
        # NewsML -> NewsItem -> NewsComponent -> NewsComponent -> DescriptiveMetadata[DateAndTime]
        descriptivemetadata = newscomponent_2_level.xpath("DescriptiveMetadata")[0]
        self.assertEqual(descriptivemetadata.attrib["DateAndTime"], "20190828T112217")
        # NewsML -> NewsItem -> NewsComponent -> NewsComponent -> NewsComponent(title) -> ContentItem
        datacontent = newscomponent_2_level.xpath(
            'NewsComponent/Role[@FormalName="Title"]/ancestor::NewsComponent/ContentItem/DataContent'
        )[0]
        self.assertEqual(datacontent.text, "20190827_zap_d99_014.jpg")
        sizeinbytes = newscomponent_2_level.xpath(
            'NewsComponent/Role[@FormalName="Title"]/ancestor::NewsComponent'
            "/ContentItem/Characteristics/SizeInBytes"
        )
        self.assertEqual(sizeinbytes[0].text, "24")
        # NewsML -> NewsItem -> NewsComponent -> NewsComponent -> NewsComponent(caption) -> ContentItem
        datacontent = newscomponent_2_level.xpath(
            'NewsComponent/Role[@FormalName="Caption"]/ancestor::NewsComponent/ContentItem/DataContent'
        )
        ...
        self.assertEqual(sizeinbytes[0].text, "858")
        # NewsML -> NewsItem -> NewsComponent -> NewsComponent -> NewsComponent(Image) -> ContentItem
        contentitem = newscomponent_2_level.xpath(
            'NewsComponent/Role[@FormalName="Image"]/ancestor::NewsComponent/ContentItem'
        )[0]
        ...
        self.assertEqual(property.attrib["Value"], "5472")
        property = newscomponent_2_level.xpath(
            'NewsComponent/Role[@FormalName="Image"]/ancestor::NewsComponent'
            '/ContentItem/Characteristics/Property[@FormalName="Height"]'
        )[0]
        self.assertEqual(property.attrib["Value"], "3648")
        # NewsML -> NewsItem -> NewsComponent -> NewsComponent -> NewsComponent(Thumbnail) -> ContentItem
        contentitem = newscomponent_2_level.xpath(
            'NewsComponent/Role[@FormalName="Thumbnail"]/ancestor::NewsComponent/ContentItem'
        )[0]
    ...
    def test_uploaded_picture_related_images(self):
        ...
        self.assertEqual(property.attrib["Value"], "1920")
        property = newscomponent_2_level.xpath(
            'NewsComponent/Role[@FormalName="Image"]/ancestor::NewsComponent'
            '/ContentItem/Characteristics/Property[@FormalName="Height"]'
        )[0]
        self.assertEqual(property.attrib["Value"], "1280")
        # NewsML -> NewsItem -> NewsComponent -> NewsComponent -> NewsComponent(Thumbnail) -> ContentItem
        contentitem = newscomponent_2_level.xpath(
            'NewsComponent/Role[@FormalName="Thumbnail"]/ancestor::NewsComponent/ContentItem'
        )[0]
    ...
    def test_belga_picture_related_images(self):
        ...
        self.assertEqual(property.attrib["Value"], "4288")
        property = newscomponent_2_level.xpath(
            'NewsComponent/Role[@FormalName="Image"]/ancestor::NewsComponent'
            '/ContentItem/Characteristics/Property[@FormalName="Height"]'
        )[0]
        self.assertEqual(property.attrib["Value"], "3012")
        # NewsML -> NewsItem -> NewsComponent -> NewsComponent -> NewsComponent(Thumbnail) -> ContentItem
        contentitem = newscomponent_2_level.xpath(
            'NewsComponent/Role[@FormalName="Thumbnail"]/ancestor::NewsComponent/ContentItem'
        )[0]
    ...
    def test_uploaded_picture_related_gallery(self):
        ...
        self.assertEqual(
            contentitem.attrib["Href"], "urn:www.belga.be:superdesk:tst:pic_3"
        )
        # NewsML -> NewsItem -> NewsComponent -> NewsComponent -> NewsComponent(Thumbnail) -> ContentItem
        contentitem = newscomponent_2_level.xpath(
            'NewsComponent/Role[@FormalName="Thumbnail"]/ancestor::NewsComponent/ContentItem'
    ...
    def test_belga_coverages(self):
        ...
        self.assertEqual(
            datacontent.text, "RUSSIAN PARAGLIDING CHAMPIONSHIP IN STAVROPOL TERRITORY"
        )
        sizeinbytes = newscomponent_2_level.xpath(
            'NewsComponent/Role[@FormalName="Title"]/ancestor::NewsComponent'
            "/ContentItem/Characteristics/SizeInBytes"
        )
        self.assertEqual(sizeinbytes[0].text, "55")
        # NewsML -> NewsItem -> NewsComponent -> NewsComponent -> NewsComponent(caption) -> ContentItem
        datacontent = newscomponent_2_level.xpath(
            'NewsComponent/Role[@FormalName="Caption"]/ancestor::NewsComponent/ContentItem/DataContent'
        )
        ...
        self.assertEqual(sizeinbytes[0].text, "145")
        # NewsML -> NewsItem -> NewsComponent -> NewsComponent -> NewsComponent
        contentitem = newscomponent_2_level.xpath(
            'NewsComponent/Role[@FormalName="Component"]/ancestor::NewsComponent/ContentItem'
        )[0]
        self.assertEqual(
            contentitem.attrib["Href"], "urn:www.belga.be:belgagallery:6690595"
        )
        _format = newscomponent_2_level.xpath(
    ...
    def test_belga_coverage_custom_field(self):
        ...
        self.assertEqual(datacontent.text, "JUDO   JPN   WORLD")
        sizeinbytes = newscomponent_2_level.xpath(
            'NewsComponent/Role[@FormalName="Title"]/ancestor::NewsComponent'
            "/ContentItem/Characteristics/SizeInBytes"
        )
        self.assertEqual(sizeinbytes[0].text, "18")
        # NewsML -> NewsItem -> NewsComponent -> NewsComponent -> NewsComponent(caption) -> ContentItem
        datacontent = newscomponent_2_level.xpath(
            'NewsComponent/Role[@FormalName="Caption"]/ancestor::NewsComponent/ContentItem/DataContent'
        )
        ...
        self.assertEqual(sizeinbytes[0].text, "74")
        # NewsML -> NewsItem -> NewsComponent -> NewsComponent -> NewsComponent
        contentitem = newscomponent_2_level.xpath(
            'NewsComponent/Role[@FormalName="Component"]/ancestor::NewsComponent/ContentItem'
        )[0]
        self.assertEqual(
            contentitem.attrib["Href"], "urn:www.belga.be:belgagallery:6666666"
        )
        _format = newscomponent_2_level.xpath(
            'NewsComponent/Role[@FormalName="Component"]/ancestor::NewsComponent/ContentItem/Format'
        )[0]
    ...
    def test_audio_in_editor_and_related(self):
        ...
        # NewsML -> NewsItem -> NewsComponent -> NewsComponent -> NewsLines -> HeadLine
        self.assertEqual(
            newscomponent_2_level.xpath("NewsLines/HeadLine")[0].text, "audio head"
        )
        # NewsML -> NewsItem -> NewsComponent -> NewsComponent -> NewsComponent(title) -> ContentItem
        datacontent = newscomponent_2_level.xpath(
            'NewsComponent/Role[@FormalName="Title"]/ancestor::NewsComponent/ContentItem/DataContent'
        )[0]
        self.assertEqual(datacontent.text, "audio head")
        sizeinbytes = newscomponent_2_level.xpath(
            'NewsComponent/Role[@FormalName="Title"]/ancestor::NewsComponent'
            "/ContentItem/Characteristics/SizeInBytes"
        )
        self.assertEqual(sizeinbytes[0].text, "10")
    ...
    def test_attachment(self):
        # NewsML -> NewsItem -> NewsComponent -> NewsComponent
        newscomponent_2_level = self.newsml.xpath(
            "NewsItem/NewsComponent/NewsComponent" '[@Duid="5d692b76c8f549e289b0270b"]'
        )[0]
        ...
        # NewsML -> NewsItem -> NewsComponent -> NewsComponent -> NewsLines -> HeadLine
        self.assertEqual(
            newscomponent_2_level.xpath("NewsLines/HeadLine")[0].text, "booktype pdf"
        )
        # NewsML -> NewsItem -> NewsComponent -> NewsComponent -> NewsComponent(title) -> ContentItem
        datacontent = newscomponent_2_level.xpath(
            'NewsComponent/Role[@FormalName="Title"]/ancestor::NewsComponent/ContentItem/DataContent'
        )[0]
        self.assertEqual(datacontent.text, "booktype pdf")
        sizeinbytes = newscomponent_2_level.xpath(
            'NewsComponent/Role[@FormalName="Title"]/ancestor::NewsComponent'
            "/ContentItem/Characteristics/SizeInBytes"
        )
        self.assertEqual(sizeinbytes[0].text, "12")
        # NewsML -> NewsItem -> NewsComponent -> NewsComponent -> NewsComponent(Body) -> ContentItem
        datacontent = newscomponent_2_level.xpath(
            'NewsComponent/Role[@FormalName="Body"]/ancestor::NewsComponent/ContentItem/DataContent'
        )[0]
        self.assertEqual(datacontent.text, "A pdf cover for a book")
        sizeinbytes = newscomponent_2_level.xpath(
            'NewsComponent/Role[@FormalName="Body"]/ancestor::NewsComponent'
            "/ContentItem/Characteristics/SizeInBytes"
        )[0]
        self.assertEqual(sizeinbytes.text, "22")
        # NewsML -> NewsItem -> NewsComponent -> NewsComponent -> NewsComponent
        contentitem = newscomponent_2_level.xpath(
            'NewsComponent/Role[@FormalName="Component"]/ancestor::NewsComponent/ContentItem'
        )[0]
        self.assertEqual(
            contentitem.attrib["Href"], "urn:www.belga.be:superdesk:tst:pdf_1"
        )
        _format = newscomponent_2_level.xpath(
            'NewsComponent/Role[@FormalName="Component"]/ancestor::NewsComponent/ContentItem/Format'
        )[0]
        self.assertEqual(_format.attrib["FormalName"], "Pdf")
        mimetype = newscomponent_2_level.xpath(
            'NewsComponent/Role[@FormalName="Component"]/ancestor::NewsComponent/ContentItem/MimeType'
        )[0]
        self.assertEqual(mimetype.attrib["FormalName"], "application/pdf")
    ...
    def test_related_article_internal(self):
        ...
        # NewsML -> NewsItem -> NewsComponent -> NewsComponent -> NewsLines -> HeadLine
        self.assertEqual(
            newscomponent_2_level.xpath("NewsLines/HeadLine")[0].text, "100 let"
        )
        # NewsML -> NewsItem -> NewsComponent -> NewsComponent -> NewsComponent(title) -> ContentItem
        datacontent = newscomponent_2_level.xpath(
            'NewsComponent/Role[@FormalName="Title"]/ancestor::NewsComponent/ContentItem/DataContent'
        )[0]
        self.assertEqual(datacontent.text, "100 let")
        sizeinbytes = newscomponent_2_level.xpath(
            'NewsComponent/Role[@FormalName="Title"]/ancestor::NewsComponent'
            "/ContentItem/Characteristics/SizeInBytes"
        )
        ...
        self.assertEqual(datacontent.text, "100 let of citroen in body")
        sizeinbytes = newscomponent_2_level.xpath(
    ...
    def test_related_article_belga_archive_text(self):
        ...
        self.assertEqual(sizeinbytes[0].text, "64")
        # NewsML -> NewsItem -> NewsComponent -> NewsComponent -> NewsComponent(Lead) -> ContentItem
        datacontent = newscomponent_2_level.xpath(
            'NewsComponent/Role[@FormalName="Lead"]/ancestor::NewsComponent/ContentItem/DataContent'
        )[0]
        ...
        self.assertEqual(sizeinbytes.text, "58")
        # NewsML -> NewsItem -> NewsComponent -> NewsComponent -> NewsComponent
        _format = newscomponent_2_level.xpath(
            'NewsComponent/Role[@FormalName="Title"]/ancestor::NewsComponent/ContentItem/Format'
        )[0]

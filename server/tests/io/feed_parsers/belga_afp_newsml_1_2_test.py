...
class BelgaAFPNewsMLOneTestCase(TestCase):
    ...
    def test_content(self):
        ...
        self.assertEqual(
            item["guid"], "urn:newsml:afp.com:20190121T104233Z:TX-PAR-RHO61:1"
        )
        ...
        self.assertEqual(
            ...
            {"item": None, "type": ["Sketch", "Photo", "Video"]},
        )
        self.assertEqual(
            item["headline"],

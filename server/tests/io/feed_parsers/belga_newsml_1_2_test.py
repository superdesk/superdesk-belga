...
class BelgaNewsMLOneTestCase(TestCase):
    ...
    def test_content(self):
        ...
        self.assertEqual(
            item["firstcreated"],
            datetime.datetime(2019, 1, 29, 11, 45, 50, tzinfo=pytz.utc),
        )
        self.assertEqual(item["guid"], "98055801")
        self.assertEqual(
            item["headline"], "Mediawatch dinsdag 29/01/2019 - VTM Nieuws - 13 uur"
        )
        ...
        expected_subjects = [
            {
                ...
                "translations": {
                    "name": {"nl": "ATTENTION USERS", "fr": "ATTENTION USERS"}
                },
        ...
        self.assertEqual(
            item["versioncreated"],
            datetime.datetime(2019, 1, 29, 12, 34, tzinfo=pytz.utc),
        )
...
class BelgaRemoteNewsMLOneTestCase(TestCase):
    ...
    def setUp(self):
        ...
        provider = {
            "name": "test",
            "config": {"path": os.path.join(dirname, "../fixtures")},
        }
        parser = BelgaNewsMLOneFeedParser()
    ...
    def test_content(self):
        ...
        self.assertEqual(
            ...
            [
                ...
                },
                {
                    ...
                    "translations": {
                        "name": {"nl": "INFRASTRUCTUUR", "fr": "INFRASTRUCTURE"}
                    },
                    "scheme": "belga-keywords",
                },
                {
        ...
        self.assertEqual(
            item["headline"],
            "Knooppunt Schijnpoort in Antwerpen hele zomervakantie afgesloten",
        )
        self.assertEqual(item["copyrightholder"], "Belga")
        ...
        self.assertEqual(
            ...
            [
                {"name": "BELGA", "qcode": "BELGA", "scheme": "sources"},
                {
                    ...
                    "qcode": "BELGAINSERT",
                    "translations": {
                        "name": {"nl": "BELGAINSERT", "fr": "BELGAINSERT"}
                    },
                    "scheme": "belga-keywords",
                },
                {

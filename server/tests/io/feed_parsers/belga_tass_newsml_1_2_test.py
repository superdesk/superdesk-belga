...
class BelgaTASSNewsMLOneTestCase(TestCase):
    ...
    def test_content(self):
        ...
        expected_subjects = [
            ...
            {
                "name": "itartassrubric_ECONOMY",
                "qcode": "itartassrubric_ECONOMY",
        ...
        self.assertEqual(
            item["headline"], "Kremlin has 'negative reaction' to upcoming EU sanctions"
        )
        self.assertEqual(item["language"], "en")
        self.assertEqual(item["descriptive_guid"], "16AAC34CE1C503AE4325838900396A95")
        self.assertEqual(
            item["extra"], {"how_present": "Origin", "country": "RUS", "city": "MOSCOW"}
        )

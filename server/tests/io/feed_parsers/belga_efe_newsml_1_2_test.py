    ...
    def test_content(self):
        ...
        expected_subjects = [
            ...
            },
            {
                "name": "India",
                "qcode": "ind",
                "translations": {"name": {"nl": "India", "fr": "Inde"}},
                "scheme": "countries",
            },
            {
                "name": "INDIA SUCESOS",
        ...
        self.assertEqual(
            item["sentfrom"], {"party": "EFE", "organization": "Agencia EFE"}
        )
        self.assertEqual(item["duid"], "text_25413502")
        self.assertEqual(
            item["comment"], {"version": "1.0.1", "name": "EfeNewsMLVersion"}
        )
        ...
        self.assertEqual(
            item["guid"],
            "urn:newsml:texto.efeservicios.com:20190121T103600+0000:25413502:1",
        )
        ...
        self.assertEqual(
            item["headline"],
            "Leones matan a un joven que se coló en un zoológico de la India",
        )
        ...
        self.assertEqual(
            item["administrative"], {"provider": "Agencia EFE", "creator": "daa/mt/msr"}
        )
